...
CREATE OR ALTER PROCEDURE AP2SP_PF_LC_002Eng
...
BEGIN
	...
	'' as OldProvince, '' as CustNameTransferNew, '' as NewAge, '' as NewAddress, '' as NewMoo, '' as NewVillage, '' as NewSoi, '' as NewRoad, '' as NewSubdistrict, '' as NewDistrict,
