...
namespace CRMReport.PrintForms.LC {
    ...
    public class PF_LC_002_2 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "CRMReport.PrintForms.LC.PF_LC_002_2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPF_LC_002_2 : Component, ICachedReport {
        
        public CachedPF_LC_002_2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PF_LC_002_2 rpt = new PF_LC_002_2();
            rpt.Site = this.Site;
            return rpt;
        }
