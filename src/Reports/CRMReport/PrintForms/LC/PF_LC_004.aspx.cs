...
{
    public partial class PF_LC_0041 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            PFP.ProductID = Request.QueryString["ProductID"] != null ? Request.QueryString["ProductID"] : "";
            PFP.DateStart = Request.QueryString["DateStart"] != null ? Request.QueryString["DateStart"] : "";
            PFP.UnitNumber = Request.QueryString["UnitNumber"] != null ? Request.QueryString["UnitNumber"] : "";

            //Convert to DateTime
            if (!string.IsNullOrEmpty(PFP.DateStart))
            {
                PFP.DS = new DateTime(Convert.ToInt64(PFP.DateStart));
            }
            ...
            try
            {
                ...
                //Main Report
                cmd = new SqlCommand("AP2SP_PF_LC_004", con);
                cmd.Parameters.AddWithValue("@ProductID", PFP.ProductID);
                cmd.Parameters.AddWithValue("@UnitNumber", PFP.UnitNumber);
                cmd.Parameters.AddWithValue("@DateStart", PFP.DS);
                ...
                crystalReport.SetParameterValue("@ProductID", PFP.ProductID);
                crystalReport.SetParameterValue("@UnitNumber", PFP.UnitNumber);
                crystalReport.SetParameterValue("@DateStart", PFP.DS);
