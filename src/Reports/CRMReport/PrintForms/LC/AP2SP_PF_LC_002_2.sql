...
CREATE OR ALTER PROCEDURE AP2SP_PF_LC_002_2
...
BEGIN
	...
	'' as PaidText, '' as TransferDate, '' as ReceivedID, '' as EffectDate, '' as SignDate, '' as ProductID, '' as BUID, '' as ForType, '' as TypeDesc from ReportTemplate
END
GO

exec AP2SP_PF_LC_002_2