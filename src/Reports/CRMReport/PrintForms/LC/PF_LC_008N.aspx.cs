...
{
    public partial class PF_LC_008N1 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Main Report
                cmd = new SqlCommand("PF_LC_008N", con);
                ...
                //SubReport 1
                cmd = new SqlCommand("PF_LC_008N_1", con);
                cmd.Parameters.AddWithValue("@QuotationNo", PFP.QuotationNo);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                //SubReport 2
                cmd = new SqlCommand("PF_LC_008N_2", con);
                cmd.Parameters.AddWithValue("@QuotationNo", PFP.QuotationNo);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
