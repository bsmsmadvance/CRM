...
namespace CRMReport.PrintForms.LC {
    ...
    public class PF_LC_002Eng : ReportClass {
    ...
    public class CachedPF_LC_002Eng : Component, ICachedReport {
        
        public CachedPF_LC_002Eng() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PF_LC_002Eng rpt = new PF_LC_002Eng();
            rpt.Site = this.Site;
            return rpt;
        }
