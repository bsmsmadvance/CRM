...
{
    public partial class PF_FET_0031 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                PFP.reportName = "PF_FET_003";
                
                //Check for authorization
                var isAuthorized = SM.checkForAuthorization(PFP.token, PFP.reportName);
                PFP.fullReportPath = "/PrintForms/Other/" + PFP.reportName + ".rpt";
                ...
                //Main Report
                cmd = new SqlCommand("PF_FET_003", con);
