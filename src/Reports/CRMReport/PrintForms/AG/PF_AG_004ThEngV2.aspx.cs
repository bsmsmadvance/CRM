...
{
    public partial class PF_AG_004ThEngV21 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            PFP.OperateType = Request.QueryString["OperateType"] != null ? Request.QueryString["OperateType"] : "";
            ...
            try
            {
                PFP.reportName = "PF_AG_004ThEngV2";
                ...
                //Main Report
                cmd = new SqlCommand("AP2SP_PF_AG_004_TH_EN", con);
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    PFP.HistoryID = dt.Rows[0]["HistoryID"].ToString();
                    PFP.OperateType = dt.Rows[0]["OperateType"].ToString();
                }

                //Sub_PF_AG_005.rpt
                cmd = new SqlCommand("AP2SP_PF_AG_005_2", con);
                cmd.Parameters.AddWithValue("@ContractNumber", PFP.ContractNumber);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                cmd = new SqlCommand("AP2SP_PF_AG_005_1_2", con);
                cmd.Parameters.AddWithValue("@ContractNumber", PFP.ContractNumber);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                //PF_AG_010.rpt
                cmd = new SqlCommand("AP2SP_PF_AG_010_TH_EN", con);
                cmd.Parameters.AddWithValue("@ContractNumber", PFP.ContractNumber);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                foreach (ReportDocument rd in crystalReport.Subreports)
                {
                    ...
                    else if (rd.Name == "Sub_PF_AG_005EN")
                    {
