...
namespace CRMReport.PrintForms.AG {
    ...
    public class PF_AG_009Eng : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "CRMReport.PrintForms.AG.PF_AG_009Eng.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPF_AG_009Eng : Component, ICachedReport {
        
        public CachedPF_AG_009Eng() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PF_AG_009Eng rpt = new PF_AG_009Eng();
            rpt.Site = this.Site;
            return rpt;
        }
