...
namespace CRMReport.PrintForms.AG {
    ...
    public class PF_AG_002Eng : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "CRMReport.PrintForms.AG.PF_AG_002Eng.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPF_AG_002Eng : Component, ICachedReport {
        
        public CachedPF_AG_002Eng() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PF_AG_002Eng rpt = new PF_AG_002Eng();
            rpt.Site = this.Site;
            return rpt;
        }
