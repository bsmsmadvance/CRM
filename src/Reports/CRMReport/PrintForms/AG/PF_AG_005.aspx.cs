...
{
    public partial class PF_AG_0051 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Main Report
                cmd = new SqlCommand("AP2SP_PF_AG_005", con);
                ...
                //PF_AG_007.rpt
                cmd = new SqlCommand("AP2SP_PF_AG_007", con);
                cmd.Parameters.AddWithValue("@ContractNumber", PFP.ContractNumber);
