...
{
    public partial class PF_AG_004ThEng1 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Main Report
                cmd = new SqlCommand("AP2SP_PF_AG_004", con);
                ...
                //PF_AG_010.rpt
                cmd = new SqlCommand("AP2SP_PF_AG_10", con);
                cmd.Parameters.AddWithValue("@ContractNumber", PFP.ContractNumber);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                foreach (ReportDocument rd in crystalReport.Subreports)
                {
                    ...
                    else if (rd.Name == "Sub_PF_AG_005EN.rpt")
                    {
