...
namespace CRMReport.PrintForms.AG {
    ...
    public class PF_AG_016H : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "CRMReport.PrintForms.AG.PF_AG_016H.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPF_AG_016H : Component, ICachedReport {
        
        public CachedPF_AG_016H() {
        }
