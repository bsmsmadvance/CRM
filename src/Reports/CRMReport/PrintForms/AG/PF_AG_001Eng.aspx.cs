...
{
    public partial class PF_AG_001Eng1 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Main Report
                cmd = new SqlCommand("AP2SP_PF_AG_001Eng", con);
                ...
                /*if (dt != null)
                {
                    ...
                    {
                        PFP.ContractNumber = row["OperateType"].ToString();
                    }
                ...
                //Period Payment
                cmd = new SqlCommand("AP2SP_PF_AG_001_1Eng", con);
                cmd.Parameters.AddWithValue("@ContractNumber", PFP.ContractNumber);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                cmd = new SqlCommand("AP2SP_PF_AG_001_2Eng", con);
                cmd.Parameters.AddWithValue("@ContractNumber", PFP.ContractNumber);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
