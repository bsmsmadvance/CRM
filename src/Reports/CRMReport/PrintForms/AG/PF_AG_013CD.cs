...
namespace CRMReport.PrintForms.AG {
    ...
    public class PF_AG_013CD : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "CRMReport.PrintForms.AG.PF_AG_013CD.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPF_AG_013CD : Component, ICachedReport {
        
        public CachedPF_AG_013CD() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PF_AG_013CD rpt = new PF_AG_013CD();
            rpt.Site = this.Site;
            return rpt;
        }
