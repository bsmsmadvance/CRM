...
namespace CRMReport.PrintForms.AG {
    ...
    public class PF_AG_017CDEng : ReportClass {
        
        public PF_AG_017CDEng() {
        }
        
        public override string ResourceName {
            get {
                return "PF_AG_017CDEng.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "CRMReport.PrintForms.AG.PF_AG_017CDEng.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPF_AG_017CDEng : Component, ICachedReport {
        
        public CachedPF_AG_017CDEng() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PF_AG_017CDEng rpt = new PF_AG_017CDEng();
            rpt.Site = this.Site;
            return rpt;
        }
