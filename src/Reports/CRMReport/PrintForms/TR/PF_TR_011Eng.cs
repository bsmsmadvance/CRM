...
namespace CRMReport.PrintForms.TR {
    ...
    public class PF_TR_011Eng : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "CRMReport.PrintForms.TR.PF_TR_011Eng.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPF_TR_011Eng : Component, ICachedReport {
        
        public CachedPF_TR_011Eng() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PF_TR_011Eng rpt = new PF_TR_011Eng();
            rpt.Site = this.Site;
            return rpt;
        }
