...
{
    public partial class PF_TR_ALL_Upcountry1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                PFP.reportName = "PF_TR_ALL_Upcountry";
                PFP.fullReportPath = "/Reports/PF/" + PFP.reportName + ".rpt";
                //PFP.fullReportPath = "/Reports/PF/" + PFP.reportName + "/" + PFP.reportName + ".rpt";

                string reportPath = ConfigurationManager.AppSettings["ReportPath"];
                crystalReport.Load(Server.MapPath(PFP.fullReportPath));
                //crystalReport.Load("C:\\inetpub\\wwwroot\\crmreport\\Reports\\PF\\\\PF_TR_ALL_Upcountry.rpt");
