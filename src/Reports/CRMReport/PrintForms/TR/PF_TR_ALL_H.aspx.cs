...
{
    public partial class PF_TR_ALL_H1 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Main Report
                cmd = new SqlCommand("AP2SP_PF_TR_001H", con);
                ...
                cmd = new SqlCommand("AP2SP_PF_TR_001H_1", con);
                cmd.Parameters.AddWithValue("@ContractNumber", PFP.ContractNumber);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                //PF_TR_002H.rpt
                cmd = new SqlCommand("AP2SP_PF_TR_002H", con);
                cmd.Parameters.AddWithValue("@ContractNumber", PFP.ContractNumber);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                //PF_TR_005H.rpt
                cmd = new SqlCommand("AP2SP_PF_TR_005H", con);
                cmd.Parameters.AddWithValue("@ContractNumber", PFP.ContractNumber);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                cmd = new SqlCommand("AP2SP_PF_TR_005H_1", con);
                cmd.Parameters.AddWithValue("@ContractNumber", PFP.ContractNumber);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                //PF_LC_003H.rpt
                cmd = new SqlCommand("AP2SP_PF_LC_003H", con);
                cmd.Parameters.AddWithValue("@TransferNumber", PFP.TransferNumber);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                //PF_TR_006H.rpt
                cmd = new SqlCommand("AP2SP_PF_TR_006H", con);
                cmd.Parameters.AddWithValue("@TransferNumber", PFP.TransferNumber);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                //PF_LC_003_H_Eng.rpt
                cmd = new SqlCommand("AP2SP_PF_LC_003_HEng", con);
                cmd.Parameters.AddWithValue("@TransferNumber", PFP.TransferNumber);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                {
                    srName.Add(rd.Name);
                    if (rd.Name == "PF_TR_001H.rpt")
                    {
                        crystalReport.Subreports[rd.Name].SetDataSource(ds.Tables[2]);
                    }
                    else if (rd.Name == "PF_TR_002H.rpt")
                    {
                        crystalReport.Subreports[rd.Name].SetDataSource(ds.Tables[4]);
                    }
                    else if (rd.Name == "PF_TR_003H.rpt")
                    {
                        crystalReport.Subreports[rd.Name].SetDataSource(ds.Tables[5]);
                    }
                    else if (rd.Name == "PF_TR_005H.rpt")
                    {
                        crystalReport.Subreports[rd.Name].SetDataSource(ds.Tables[7]);
                    }
                    else if (rd.Name == "PF_TR_005H_1.rpt")
                    {
                        crystalReport.Subreports[rd.Name].SetDataSource(ds.Tables[9]);
                    }
                    else if (rd.Name == "PF_LC_003H.rpt")
                    {
                    ...
                    else if (rd.Name == "PF_TR_006H.rpt")
                    {
                        crystalReport.Subreports[rd.Name].SetDataSource(ds.Tables[13]);
                    }
                    else if (rd.Name == "PF_LC_003_H_Eng.rpt")
                    {
