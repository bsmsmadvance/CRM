...
{
    public partial class PF_TR_009_PT21 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            PFP.CustomerBankName2 = Request.QueryString["CustomerBankName2"] != null ? Request.QueryString["CustomerBankName2"] : "";
            PFP.CustomerBankType2 = Request.QueryString["CustomerBankType2"] != null ? Request.QueryString["CustomerBankType2"] : "";
            PFP.CustomerBankNo2 = Request.QueryString["CustomerBankNo2"] != null ? Request.QueryString["CustomerBankNo2"] : "";
            PFP.ContactID2 = Request.QueryString["ContactID2"] != null ? Request.QueryString["ContactID2"] : "";
            ...
            try
            {
                ...
                //Main Report
                cmd = new SqlCommand("AP2SP_PF_TR_009_PT", con);
                ...
                cmd.Parameters.AddWithValue("@CustomerBankName2", PFP.CustomerBankName2);
                cmd.Parameters.AddWithValue("@CustomerBankType2", PFP.CustomerBankType2);
                cmd.Parameters.AddWithValue("@CustomerBankNo2", PFP.CustomerBankNo2);
                cmd.Parameters.AddWithValue("@ContactID2", PFP.ContactID2);
                ...
                crystalReport.SetParameterValue("@CustomerBankName2", PFP.CustomerBankName2);
                crystalReport.SetParameterValue("@CustomerBankType2", PFP.CustomerBankType2);
                crystalReport.SetParameterValue("@CustomerBankNo2", PFP.CustomerBankNo2);
                crystalReport.SetParameterValue("@ContactID2", PFP.ContactID2);
