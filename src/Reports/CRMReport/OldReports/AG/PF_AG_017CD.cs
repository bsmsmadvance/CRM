...
namespace CRMReport.OldReports.AG {
    ...
    public class PF_AG_017CD : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "CRMReport.OldReports.AG.PF_AG_017CD.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPF_AG_017CD : Component, ICachedReport {
        
        public CachedPF_AG_017CD() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PF_AG_017CD rpt = new PF_AG_017CD();
            rpt.Site = this.Site;
            return rpt;
        }
