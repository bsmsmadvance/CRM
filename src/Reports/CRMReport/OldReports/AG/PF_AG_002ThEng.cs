...
namespace CRMReport.OldReports.AG {
    ...
    public class PF_AG_002ThEng : ReportClass {
        
        public PF_AG_002ThEng() {
        }
        
        public override string ResourceName {
            get {
                return "PF_AG_002ThEng.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "CRMReport.OldReports.AG.PF_AG_002ThEng.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPF_AG_002ThEng : Component, ICachedReport {
        
        public CachedPF_AG_002ThEng() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PF_AG_002ThEng rpt = new PF_AG_002ThEng();
            rpt.Site = this.Site;
            return rpt;
        }
