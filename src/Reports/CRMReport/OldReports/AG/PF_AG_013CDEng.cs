...
namespace CRMReport.OldReports.AG {
    ...
    public class PF_AG_013CDEng : ReportClass {
        
        public PF_AG_013CDEng() {
        }
        
        public override string ResourceName {
            get {
                return "PF_AG_013CDEng.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "CRMReport.OldReports.AG.PF_AG_013CDEng.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPF_AG_013CDEng : Component, ICachedReport {
        
        public CachedPF_AG_013CDEng() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PF_AG_013CDEng rpt = new PF_AG_013CDEng();
            rpt.Site = this.Site;
            return rpt;
        }
