...
namespace CRMReport.OldReports.AG {
    ...
    public class PF_AG_004Eng : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "CRMReport.OldReports.AG.PF_AG_004Eng.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPF_AG_004Eng : Component, ICachedReport {
        
        public CachedPF_AG_004Eng() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PF_AG_004Eng rpt = new PF_AG_004Eng();
            rpt.Site = this.Site;
            return rpt;
        }
