...
namespace CRMReport.OldReports.AG {
    using System;
    ...
    public class PF_AG_005_NotAllocate : ReportClass {
        
        public PF_AG_005_NotAllocate() {
        }
        
        public override string ResourceName {
            get {
                return "PF_AG_005_NotAllocate.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "CRMReport.OldReports.AG.PF_AG_005_NotAllocate.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPF_AG_005_NotAllocate : Component, ICachedReport {
        
        public CachedPF_AG_005_NotAllocate() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PF_AG_005_NotAllocate rpt = new PF_AG_005_NotAllocate();
            rpt.Site = this.Site;
            return rpt;
        }
