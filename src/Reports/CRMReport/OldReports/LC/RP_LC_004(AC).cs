...
namespace CRMReport.OldReports.LC {
    ...
    public class RP_LC_004AC : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "CRMReport.OldReports.LC.RP_LC_004(AC).rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRP_LC_004AC : Component, ICachedReport {
        
        public CachedRP_LC_004AC() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RP_LC_004AC rpt = new RP_LC_004AC();
            rpt.Site = this.Site;
            return rpt;
        }
