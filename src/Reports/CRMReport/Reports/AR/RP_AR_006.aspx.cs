...
{
    public partial class RP_AR_0061 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ARP.reportName = "RP_AR_006";
                fullReportPath = "/Reports/AR/" + ARP.reportName + ".rpt";

                string reportPath = ConfigurationManager.AppSettings["ReportPath"];
                crystalReport.Load(Server.MapPath(fullReportPath));
                //crystalReport.Load("C:\\inetpub\\wwwroot\\crmreport\\Reports\\AR\\RP_AR_004\\RP_AR_006.rpt");

                cmd = new SqlCommand("AP2SP_RP_AR_006", con);
