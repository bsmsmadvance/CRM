...
{
    public partial class RP_AR_0211 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //ARP.BankAccount = Request.QueryString["BankAccount"] != null ? Request.QueryString["BankAccount"] : "";
                ...
                if (jsonParam != null)
                {
                    ...
                    ARP.BankAccount = jsonParam.BankAccount;
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_AR_021", con);
                ...
                cmd.Parameters.AddWithValue("@BankAccount", ARP.BankAccount);
                ...
                crystalReport.SetParameterValue("@BankAccount", ARP.BankAccount);
