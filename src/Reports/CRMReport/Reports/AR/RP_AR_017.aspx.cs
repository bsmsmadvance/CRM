...
{
    public partial class RP_AR_0171 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //ARP.JV = Request.QueryString["JV"] != null ? Request.QueryString["JV"] : "";
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_AR_017", con);
                ...
                cmd.Parameters.AddWithValue("@JV", ARP.JV);
                ...
                //Details
                cmd = new SqlCommand("AP2SP_RP_AR_017_1", con);
                cmd.Parameters.AddWithValue("@BatchID", ARP.BatchID);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                crystalReport.SetParameterValue("@JV", ARP.JV);
