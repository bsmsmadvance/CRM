...
{
    public partial class RP_AR_0151 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //ARP.Deposit = Request.QueryString["Deposit"] != null ? Request.QueryString["Deposit"] : "";
                ...
                if (jsonParam != null)
                {
                    ...
                    ARP.BatchID = jsonParam.BatchID;
                    ARP.Deposit = jsonParam.Deposit;
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_AR_015", con);
                ...
                cmd.Parameters.AddWithValue("@Deposit", ARP.Deposit);
                ...
                //ReceivedID
                cmd = new SqlCommand("AP2SP_RP_AR_015_1", con);
                cmd.Parameters.AddWithValue("@BatchID", ARP.BatchID);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                //Sub2
                cmd = new SqlCommand("AP2SP_RP_AR_015_2", con);
                cmd.Parameters.AddWithValue("@BatchID", ARP.BatchID);
                cmd.CommandType = CommandType.StoredProcedure;
                dtAdapter = new SqlDataAdapter(cmd);
                ...
                crystalReport.SetParameterValue("@DateStart", ARP.actualDS);
                crystalReport.SetParameterValue("@DateEnd", ARP.actualDE);
                crystalReport.SetParameterValue("@BatchID", ARP.BatchID);
                crystalReport.SetParameterValue("@Deposit", ARP.Deposit);
