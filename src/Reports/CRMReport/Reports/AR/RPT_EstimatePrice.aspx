<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMaster.Master" AutoEventWireup="true" CodeBehind="RPT_EstimatePrice.aspx.cs" Inherits="CRMReport.Reports.AR.RPT_EstimatePrice1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <CR:CrystalReportSource ID="CRS" runat="server">
        <Report FileName="RPT_EstimatePrice.rpt">
            </Report>
