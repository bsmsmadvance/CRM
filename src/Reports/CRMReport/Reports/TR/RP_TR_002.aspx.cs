...
{
    public partial class RP_TR_0021 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_TR_002", con);
                ...
                //RPT1
                cmd = new SqlCommand("AP2SP_RP_TR_002_1", con);
                cmd.CommandTimeout = 6000;
                cmd.Parameters.AddWithValue("@Projects", TRP.Projects);
                cmd.Parameters.AddWithValue("@UnitNumber", TRP.UnitNumber);
                cmd.Parameters.AddWithValue("@DateStart", TRP.actualDS);
