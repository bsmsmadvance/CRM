...
-- [dbo].[AP2SP_NRP_TR_005_2_CD_1] '','10020','','','Administrator Account'
CREATE PROC [dbo].[AP2SP_NRP_TR_005_2_CD_1]
...
WHERE	TC.ChequeOrder = 1 And TC.CompanyID <> ''0'' And PR.Producttype = ''โครงการแนวสูง''' 
