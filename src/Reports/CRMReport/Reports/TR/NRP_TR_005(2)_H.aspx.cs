...
{
    public partial class NRP_TR_005_2__H : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                TRP.reportName = "NRP_TR_005(2)_H";
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_TR_005_2_H", con);
                ...
                //Remark
                cmd = new SqlCommand("AP2SP_RP_TR_005_2_H_1", con);
                cmd.CommandTimeout = 6000;
                cmd.Parameters.AddWithValue("@CompanyID", TRP.CompanyID);
                cmd.Parameters.AddWithValue("@ProductID", TRP.ProductID);
                cmd.Parameters.AddWithValue("@DateStart", TRP.actualDS);
