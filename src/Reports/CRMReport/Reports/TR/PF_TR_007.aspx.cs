...
{
    public partial class PF_TR_0071 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            TRP.downloadAs = DownloadAs.showpdf.ToString();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_TR_007", con);
                ...
                //RPT1
                cmd = new SqlCommand("AP2SP_RP_TR_007_1", con);
                cmd.CommandTimeout = 6000;
                cmd.Parameters.AddWithValue("@CompanyID", TRP.CompanyID);
                cmd.Parameters.AddWithValue("@ProductID", TRP.ProductID);
                cmd.Parameters.AddWithValue("@DateStart", TRP.actualDS);
