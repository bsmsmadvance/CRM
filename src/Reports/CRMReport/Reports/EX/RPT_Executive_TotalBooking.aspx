<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMaster.Master" AutoEventWireup="true" CodeBehind="RPT_Executive_TotalBooking.aspx.cs" Inherits="CRMReport.Reports.EX.RPT_Executive_TotalBooking1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <CR:CrystalReportSource ID="CRS" runat="server">
        <Report FileName="RPT_Executive_TotalBooking.rpt">
            </Report>
