...
{
    public partial class RP_LC_0031 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //LCP.TransferStatus = Request.QueryString["TransferStatus"] != null ? Request.QueryString["TransferStatus"] : "";
                ...
                if (jsonParam != null)
                {
                    ...
                    LCP.TransferStatus = jsonParam.TransferStatus;
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_LC_003", con);
                ...
                cmd.Parameters.AddWithValue("@TransferStatus", LCP.TransferStatus);
                ...
                {
                    if (rd.Name == "RP_LC_SUB")
                    {
                        crystalReport.Subreports[rd.Name].SetDataSource(ds.Tables[0]);
                    }
                ...
                crystalReport.SetParameterValue("@TransferStatus", LCP.TransferStatus);
