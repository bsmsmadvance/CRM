...
{
    public partial class RP_LC_0061 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //LCP.LandStatus = Request.QueryString["LandStatus"] != null ? Request.QueryString["LandStatus"] : "";
                ...
                if (jsonParam != null)
                {
                    ...
                    LCP.LandStatus = jsonParam.LandStatus;
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_LC_006", con);
                ...
                cmd.Parameters.AddWithValue("@LandStatus", LCP.LandStatus);
                ...
                crystalReport.SetParameterValue("@LandStatus", LCP.LandStatus);
