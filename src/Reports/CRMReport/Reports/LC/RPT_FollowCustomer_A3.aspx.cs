...
{
    public partial class RPT_FollowCustomer_A31 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                LCP.reportName = "RPT_FollowCustomer_A3";
                ...
                SqlCommand cmd = new SqlCommand("SP_RPT_FollowCustomer", con);
