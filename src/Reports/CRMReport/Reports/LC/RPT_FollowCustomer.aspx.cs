...
{
    public partial class RPT_FollowCustomer1 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                LCP.reportName = "RPT_FollowCustomer";
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_FollowCustomer_Revisit", con);
