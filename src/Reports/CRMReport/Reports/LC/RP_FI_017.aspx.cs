...
{
    public partial class RP_FI_0171 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //LCP.AccountStatus = Request.QueryString["AccountStatus"] != null ? Request.QueryString["AccountStatus"] : "";
                ...
                if (jsonParam != null)
                {
                    ...
                    LCP.AccountStatus = jsonParam.AccountStatus;
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_FI_017", con);
                ...
                cmd.Parameters.AddWithValue("@AccountStatus", LCP.AccountStatus);
                ...
                crystalReport.SetParameterValue("@AccountStatus", LCP.AccountStatus);
