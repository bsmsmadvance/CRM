...
{
    public partial class RP_LC_0101 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //LCP.SBUID = Request.QueryString["SBUID"] != null ? Request.QueryString["SBUID"] : "";
                ...
                //LCP.Customer = Request.QueryString["Customer"] != null ? Request.QueryString["Customer"] : "";
                ...
                if (jsonParam != null)
                {
                    ...
                    LCP.Customer = jsonParam.Customer;
                ...
                cmd.Parameters.AddWithValue("@StatusAG", LCP.StatusAG);
                cmd.Parameters.AddWithValue("@Username", LCP.UserName);
                cmd.Parameters.AddWithValue("@Customer", LCP.Customer);
                ...
                crystalReport.SetParameterValue("@SBUID", LCP.SBUID);
                ...
                crystalReport.SetParameterValue("@StatusAG", LCP.StatusAG);
                crystalReport.SetParameterValue("@UserName", LCP.UserName);
                crystalReport.SetParameterValue("@Customer", LCP.Customer);
