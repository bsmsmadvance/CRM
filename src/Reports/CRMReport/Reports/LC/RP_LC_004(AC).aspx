<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMaster.Master" AutoEventWireup="true" CodeBehind="RP_LC_004(AC).aspx.cs" Inherits="CRMReport.Reports.LC.RP_LC_004_AC_" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <CR:CrystalReportSource ID="CRS" runat="server">
        <Report FileName="RP_LC_004(AC).rpt">
            </Report>
