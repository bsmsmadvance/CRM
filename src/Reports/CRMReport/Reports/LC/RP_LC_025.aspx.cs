...
{
    public partial class RP_LC_0251 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            LCP.param = Request.QueryString["param"];
            ...
            try
            {
                ...
                //LCP.StatusDoc = Request.QueryString["StatusDoc"] != null ? Request.QueryString["StatusDoc"] : "";
                ...
                if (jsonParam != null)
                {
                    ...
                    LCP.StatusDoc = jsonParam.StatusDoc;
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_LC_025", con);
                ...
                cmd.Parameters.AddWithValue("@StatusDoc", LCP.StatusDoc);
                ...
                crystalReport.SetParameterValue("@StatusDoc", LCP.StatusDoc);
