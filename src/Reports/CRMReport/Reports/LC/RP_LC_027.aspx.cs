...
{
    public partial class RP_LC_0271 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //LCP.Projects = Request.QueryString["Projects"] != null ? Request.QueryString["Projects"] : "";
                ...
                if (jsonParam != null)
                {
                    ...
                    LCP.Projects = jsonParam.Projects;
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_LC_027", con);
                cmd.CommandTimeout = 6000;
                cmd.Parameters.AddWithValue("@CompanyID", LCP.CompanyID);
                cmd.Parameters.AddWithValue("@Projects", LCP.Projects);
