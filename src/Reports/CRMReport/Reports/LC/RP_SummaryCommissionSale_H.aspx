<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMaster.Master" AutoEventWireup="true" CodeBehind="RP_SummaryCommissionSale_H.aspx.cs" Inherits="CRMReport.Reports.LC.RP_SummaryCommissionSale_H1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <CR:CrystalReportSource ID="CRS" runat="server">
        <Report FileName="RP_SummaryCommissionSale_H.rpt">
            </Report>
