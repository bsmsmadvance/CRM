...
{
    public partial class RP_LC_0041 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //LCP.PaymentType = Request.QueryString["PaymentType"] != null ? Request.QueryString["PaymentType"] : "";
                ...
                if (jsonParam != null)
                {
                    ...
                    LCP.PaymentType = jsonParam.PaymentType;
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_LC_004", con);
                ...
                cmd.Parameters.AddWithValue("@PaymentType", LCP.PaymentType);
                ...
                crystalReport.SetParameterValue("@PaymentType", LCP.PaymentType);
