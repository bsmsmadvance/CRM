...
namespace CRMReport.Reports.AG {
    ...
    public class RPT_Transfer_Letter : ReportClass {
        
        public RPT_Transfer_Letter() {
        }
        
        public override string ResourceName {
            get {
                return "RPT_Transfer_Letter.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "CRMReport.Reports.AG.RPT_Transfer_Letter.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_Transfer_Letter : Component, ICachedReport {
        
        public CachedRPT_Transfer_Letter() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_Transfer_Letter rpt = new RPT_Transfer_Letter();
            rpt.Site = this.Site;
            return rpt;
        }
