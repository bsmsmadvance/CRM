...
{
    public partial class RP_AG_0041 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //AGP.MailType2 = Request.QueryString["MailType2"] != null ? Request.QueryString["MailType2"] : "";
                ...
                if (jsonParam != null)
                {
                    ...
                    AGP.MailType2 = jsonParam.MailType2;
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_AG_004", con);
                ...
                cmd.Parameters.AddWithValue("@MailType2", Convert.ToInt16(AGP.MailType2));
                ...
                crystalReport.SetParameterValue("@MailType2", Convert.ToInt16(AGP.MailType2));
