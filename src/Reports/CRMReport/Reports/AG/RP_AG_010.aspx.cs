...
{
    public partial class RP_AG_0101 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //AGP.Projects = Request.QueryString["Projects"] != null ? Request.QueryString["Projects"] : "";
                //AGP.UnitNumber = Request.QueryString["UnitNumber"] != null ? Request.QueryString["UnitNumber"] : "";
                //AGP.StatusAG3 = Request.QueryString["StatusAG3"] != null ? Request.QueryString["StatusAG3"] : "";
                ...
                if (jsonParam != null)
                {
                    ...
                    AGP.StatusAG3 = jsonParam.StatusAG3;
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_AG_010", con);
                cmd.CommandTimeout = 6000;
                cmd.Parameters.AddWithValue("@CompanyID", AGP.CompanyID);
                cmd.Parameters.AddWithValue("@Projetcs", AGP.Projects);
                cmd.Parameters.AddWithValue("@UnitNumber", AGP.UnitNumber);
                cmd.Parameters.AddWithValue("@StatusAG3", AGP.StatusAG3);
                ...
                crystalReport.SetParameterValue("@Projects", AGP.Projects);
                crystalReport.SetParameterValue("@UnitNumber", AGP.UnitNumber);
                crystalReport.SetParameterValue("@StatusAG3", AGP.StatusAG3);
