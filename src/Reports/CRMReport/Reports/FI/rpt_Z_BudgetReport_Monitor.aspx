<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageMaster.Master" AutoEventWireup="true" CodeBehind="rpt_Z_BudgetReport_Monitor.aspx.cs" Inherits="CRMReport.Reports.FI.rpt_Z_BudgetReport_Monitor1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <CR:CrystalReportSource ID="CRS" runat="server">
        <Report FileName="rpt_Z_BudgetReport_Monitor.rpt">
            </Report>
