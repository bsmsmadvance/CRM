...
{
    public partial class rpt_Z_BudgetReport_Summary1 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                FIP.reportName = "rpt_Z_BudgetReport_Summary";
                ...
                //FIP.Status5 = Request.QueryString["Status5"] != null ? Request.QueryString["Status5"] : "";
                ...
                SqlCommand cmd = new SqlCommand("sp_Z_BudgetReport_Summary", con);
                ...
                cmd.Parameters.AddWithValue("@Status5", FIP.Status5);
                ...
                crystalReport.SetParameterValue("@Status5", FIP.Status5);
