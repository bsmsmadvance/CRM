...
{
    public partial class RP_FI_0191 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //FIP.BookingOfflineStatus = Request.QueryString["BookingOfflineStatus"] != null ? Request.QueryString["BookingOfflineStatus"] : "";
                ...
                if (jsonParam != null)
                {
                    ...
                    FIP.BookingOfflineStatus = jsonParam.BookingOfflineStatus;
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_FI_019", con);
                ...
                cmd.Parameters.AddWithValue("@BookingOfflineStatus", FIP.BookingOfflineStatus);
                ...
                crystalReport.SetParameterValue("@BookingOfflineStatus", FIP.BookingOfflineStatus);
