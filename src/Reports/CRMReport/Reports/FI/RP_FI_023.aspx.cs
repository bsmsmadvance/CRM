...
{
    public partial class RP_FI_0231 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //FIP.WorkTransferStatus = Request.QueryString["WorkTransferStatus"] != null ? Request.QueryString["WorkTransferStatus"] : "";
                //FIP.WorkTransferDate = Request.QueryString["WorkTransferDate"] != null ? Request.QueryString["WorkTransferDate"] : "";
                ...
                if (jsonParam != null)
                {
                    ...
                    FIP.WorkTransferStatus = jsonParam.WorkTransferStatus;
                    FIP.WorkTransferDate = jsonParam.WorkTransferDate;
                    ...
                    if (!string.IsNullOrEmpty(FIP.WorkTransferDate))
                    {
                        FIP.actualWT = new DateTime(long.Parse(FIP.WorkTransferDate));
                    }
                    else
                    {
                        FIP.actualWT = new DateTime(1800, 01, 01, 00, 00, 00);
                    }
                }

                SqlCommand cmd = new SqlCommand("AP2SP_RP_FI_023", con);
                ...
                cmd.Parameters.AddWithValue("@WorkTransferStatus", FIP.WorkTransferStatus);
                cmd.Parameters.AddWithValue("@WorkTransferDate", FIP.actualWT);
                ...
                crystalReport.SetParameterValue("@WorkTransferStatus", FIP.WorkTransferStatus);
                crystalReport.SetParameterValue("@WorkTransferDate", FIP.actualWT);
