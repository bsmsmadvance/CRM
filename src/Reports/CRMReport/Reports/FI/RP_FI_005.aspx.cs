...
{
    public partial class RP_FI_0051 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //FIP.StatusAG = Request.QueryString["StatusAG"] != null ? Request.QueryString["StatusAG"] : "";
                ...
                if (jsonParam != null)
                {
                    ...
                    FIP.StatusAG = jsonParam.StatusAG;
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_FI_005", con);
                ...
                cmd.Parameters.AddWithValue("@StatusAG", FIP.StatusAG);
                ...
                crystalReport.SetParameterValue("@StatusAG", FIP.StatusAG);
