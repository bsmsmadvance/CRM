...
{
    public partial class RP_FI_0141 : System.Web.UI.Page
    {
        //Parameter
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (jsonParam != null)
                {
                    ...
                    FIP.PeriodStart = jsonParam.PeriodStart;
                    FIP.PeriodEnd = jsonParam.PeriodEnd;
                ...
                SqlCommand cmd = new SqlCommand("AP2SP_RP_FI_014", con);
