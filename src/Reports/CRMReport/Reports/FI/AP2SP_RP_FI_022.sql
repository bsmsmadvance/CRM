...
GO
-- [dbo].[AP2SP_RP_FI_022] '','10062','','','','','','1','','2'
-- [dbo].[AP2SP_RP_FI_022] '','','','2012-06-29','2012-06-29','','','','','','','','','2'
-- [dbo].[AP2SP_RP_FI_022] '','10092','','','','','','','','2'

CREATE PROCEDURE [dbo].[AP2SP_RP_FI_022]
...
DECLARE @DateEndInStore DATETIME,@DateEndInStore2 DATETIME,@DateEndInStore3 Datetime,@A varchar(5)
...
FROM	[PRJ].[Unit] UN' --This is main table and below table need to be use as well
		...
		LEFT OUTER JOIN ICON_EntForms_DocumentCheckList DC ON (DC.ContractNumber = AG.ContractNumber OR DC.BookingNumber = BK.BookingNumber)
