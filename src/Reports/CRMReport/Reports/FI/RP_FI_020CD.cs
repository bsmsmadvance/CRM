...
namespace CRMReport.Reports.FI {
    ...
    public class RP_FI_020CD : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "CRMReport.Reports.FI.RP_FI_020CD.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRP_FI_020CD : Component, ICachedReport {
        
        public CachedRP_FI_020CD() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RP_FI_020CD rpt = new RP_FI_020CD();
            rpt.Site = this.Site;
            return rpt;
        }
