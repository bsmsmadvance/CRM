...
/*
	Funcion: BahtText (แปลงจำนวนเงินเป็นข้อความภาษาไทย)
	Author: Boonserm Sangkarnnok
	CreateDate: 2009-01-22
	ใช้ได้กับตัวเลขไม่เกิน  9 แสนล้าน (13หลัก)
*/

ALTER FUNCTION [dbo].[fnBHT_BahtText]
(
	@MoneyAmt money
)
...
BEGIN
	...
	ELSE IF (@len > 1)
	  ...
	  END
		...
		SET @temp = ISNULL(@temp, '') + [dbo].[fnBHT_StangText](@MoneyAmt);
