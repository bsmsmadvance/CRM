...
namespace Base.DTOs.SAL
{
    public class TransferDTO : BaseDTO
    {
        ...
        public void ToModel(ref Transfer model)
        {
            ...
            model.StandardArea = this.StandardArea;
            model.LandArea = this.LandArea;
            model.LandEstimatePrice = this.LandEstimatePrice;
            ...
            model.CustomerPayMortgage = this.CustomerPayMortgage;
            model.CustomerPayFee = this.CustomerPayFee;
            model.CompanyPayFee = this.CompanyPayFee;
            model.FreeFee = this.FreeFee;
            model.DocumentFee = this.DocumentFee;
            model.APBalance = this.APBalance;
            //model.IsAPBalanceTransfer = this.IsAPBalanceTransfer;
            model.APBalanceTransfer = this.APBalanceTransfer;
            model.APChangeAmountBeforeTransfer = this.APChangeAmountBeforeTransfer;
            model.APChangeAmount = this.APChangeAmount;
            model.IsAPGiveChange = this.IsAPGiveChange;
            model.IsAPPayWithMemo = this.IsAPPayWithMemo;
            model.LegalEntityBalance = this.LegalEntityBalance;
            //model.IsLegalEntityBalanceTransfer = this.IsLegalEntityBalanceTransfer;
            model.LegalEntityBalanceTransfer = this.LegalEntityBalanceTransfer;
            model.IsLegalEntityGiveChange = this.IsLegalEntityGiveChange;
            model.IsLegalEntityPayWithMemo = this.IsLegalEntityPayWithMemo;
