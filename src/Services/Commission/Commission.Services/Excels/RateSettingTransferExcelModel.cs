...
{
    public class RateSettingTransferExcelModel
    {
        ...
        public static RateSettingTransferExcelModel CreateFromDataRow(DataRow dr)
        {
            var result = new RateSettingTransferExcelModel();
