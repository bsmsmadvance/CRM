...
namespace Finance.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IUnknownPaymentService, UnknownPaymentService>();

            services.AddScoped<IPaymentService, PaymentService>();
            services.AddScoped<IDirectCreditDebitApprovalFormService, DirectCreditDebitApprovalFormService>();
            services.AddScoped<IDirectCreditDebitExportService, DirectCreditDebitExportService>();
            services.AddScoped<IFETService, FETService>();
            services.AddScoped<IBillPaymentService, BillPaymentService>();
            services.AddScoped<IReceiptInfoService, ReceiptInfoService>();
            services.AddScoped<IFeeCreditDebitCardService, FeeCreditDebitCardService>();
            services.AddScoped<IFeeChequeService, FeeChequeService>();
