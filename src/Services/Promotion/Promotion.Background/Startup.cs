...
using ErrorHandling;
using Promotion.Background.Extensions;
...
namespace Promotion.Background
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHostedService<PromotionMaterialSyncHostedService>();
            services.AddScoped<IPromotionMaterialService, PromotionMaterialService>();

            services.AddHostedService<PRRequestSyncHostedService>();
            services.AddScoped<IPRRequestJobService, PRRequestJobService>();

            services.AddHostedService<PRCancelSyncHostedService>();
            services.AddScoped<IPRCancelJobService, PRCancelJobService>();
