...
namespace Database.Models.Migrations
{
    ...
    [Migration("20190519092718_RemoveFloorAndTowerInHighRiseFee")]
    partial class RemoveFloorAndTowerInHighRiseFee
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Models.CTM.Contact", b =>
                {
                    ...
                    b.Property<Guid?>("TitleMasterCenterID");
                    ...
                    b.HasIndex("TitleMasterCenterID");
            ...
            modelBuilder.Entity("Database.Models.CTM.Lead", b =>
                {
                    ...
                    b.Property<int?>("NumberOfContact");
            ...
            modelBuilder.Entity("Database.Models.MST.Agency", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Database.Models.PRM.BookingPromotionReceive", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("BookingPromotionReceive","PRM");
                });

            modelBuilder.Entity("Database.Models.PRM.BookingPromotionReceiveItem", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<Guid?>("BookingPromotionReceiveID");
                    ...
                    b.Property<DateTime?>("EstimateReceiveDate");
                    ...
                    b.HasIndex("BookingPromotionReceiveID");

                    b.ToTable("BookingPromotionReceiveItem","PRM");
                });
            ...
            modelBuilder.Entity("Database.Models.PRM.TransferPromotionReceive", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TransferPromotionReceive","PRM");
                });

            modelBuilder.Entity("Database.Models.PRM.TransferPromotionReceiveItem", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<Guid?>("TransferPromotionReceiveID");
                    ...
                    b.HasIndex("TransferPromotionReceiveID");

                    b.ToTable("TransferPromotionReceiveItem","PRM");
                });
            ...
            modelBuilder.Entity("Database.Models.SAL.UnitPriceInstallmentItem", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("UnitPriceInstallmentItem","SAL");
                });
            ...
            modelBuilder.Entity("Database.Models.CTM.Contact", b =>
                {
                    ...
                    b.HasOne("Database.Models.MST.MasterCenter", "Title")
                        .WithMany()
                        .HasForeignKey("TitleMasterCenterID");
                });
            ...
            modelBuilder.Entity("Database.Models.PRM.BookingPromotionReceiveItem", b =>
                {
                    ...
                    b.HasOne("Database.Models.PRM.BookingPromotionReceive", "BookingPromotionReceive")
                        .WithMany()
                        .HasForeignKey("BookingPromotionReceiveID");
                });
            ...
            modelBuilder.Entity("Database.Models.PRM.TransferPromotionReceiveItem", b =>
                {
                    ...
                    b.HasOne("Database.Models.PRM.TransferPromotionReceive", "TransferPromotionReceive")
                        .WithMany()
                        .HasForeignKey("TransferPromotionReceiveID");
                });
