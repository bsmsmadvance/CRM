...
namespace IO.Swagger.Model {
  ...
  public class RevisitActivityDTO {
    ...
    /// <summary>
    /// ประเภท Activity  masterdata/api/MasterCenters/DropdownList?masterCenterGroupKey=RevisitActivityType
    /// </summary>
    /// <value>ประเภท Activity  masterdata/api/MasterCenters/DropdownList?masterCenterGroupKey=RevisitActivityType</value>
    ...
    /// Activity การติดตาม
    /// </summary>
    /// <value>Activity การติดตาม</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class RevisitActivityDTO {\n");
