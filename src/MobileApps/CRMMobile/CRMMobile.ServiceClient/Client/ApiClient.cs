...
namespace IO.Swagger.Client
{
    ...
    public class ApiClient
    {
        ...
        public ApiClient(String basePath = "http://crmrevo-customer-api-crmrevo-dev.devops-app.apthai.com")
        {
            BasePath = basePath;
        ...
        {
            return HttpUtility.UrlEncode(str); // return RestSharp.Extensions.  //Authenticators.HttpUtility.UrlEncode(str);
        }
        ...
        public string Serialize(object obj)
        {
            try
            {
                JsonSerializerSettings DateFormatSettings = new JsonSerializerSettings
                {
                    ...
                    DateFormatString = Configuration.CRM_DATETIME_FORMAT
                };

                return obj != null ? JsonConvert.SerializeObject(obj, DateFormatSettings) : null;
            }
            catch (Exception e)
            {
                throw new ApiException(500, e.Message);
