...
namespace CRMMobile.Layout
{
    ...
    public partial class CollapseVisitorLayout : ContentView
    {
        private bool _collapsed;
        private double OriginalHeight;

        public CollapseVisitorLayout()
        {
            InitializeComponent();
        }
        ...
        public static readonly BindableProperty EditCommandProperty = BindableProperty.Create(nameof(EditCommand), typeof(ICommand), typeof(CollapseVisitorLayout), null);
